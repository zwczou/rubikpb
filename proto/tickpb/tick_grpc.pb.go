...
type TickServiceClient interface {
	// 获取支持的交易所
	ListExchange(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListExchangeResponse, error)
	// 获取交易所交易对
...
func (c *tickServiceClient) ListExchange(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListExchangeResponse, error) {
	out := new(ListExchangeResponse)
	err := c.cc.Invoke(ctx, "/tickpb.TickService/ListExchange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickServiceClient) ListSymbol(ctx context.Context, in *ListSymbolRequest, opts ...grpc.CallOption) (*ListSymbolResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/tickpb.TickService/ListSymbol", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tickServiceClient) Subscribe(ctx context.Context, opts ...grpc.CallOption) (TickService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &TickService_ServiceDesc.Streams[0], "/tickpb.TickService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
type TickServiceServer interface {
	// 获取支持的交易所
	ListExchange(context.Context, *emptypb.Empty) (*ListExchangeResponse, error)
	// 获取交易所交易对
...
func (UnimplementedTickServiceServer) ListExchange(context.Context, *emptypb.Empty) (*ListExchangeResponse, error) {
...
func _TickService_ListExchange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tickpb.TickService/ListExchange",
	}
...
func _TickService_ListSymbol_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tickpb.TickService/ListSymbol",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TickService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tickpb.TickService",
